...
- Do not use horizontal rules such as `---` as visual decoration.
- Do not add ornamental separators, banners, repeated punctuation, or similar filler characters.
- Prefer simple headings, short paragraphs, and plain bullet lists.
- Prefer formatting that improves navigation, comprehension, or correctness over formatting that only adds visual emphasis.
...
- When editing repository text files, remove decorative elements that do not improve clarity.
