...
This directory contains repo-specific maintenance rules for this repository. These files guide how reusable skills, rules, workflows, hooks, documentation, and validation tooling are maintained here.
...
- `04-sync-source-of-truth.md`: Source-of-truth rules for synced workflows and hooks.
...
- `.clinerules/hooks/PreToolUse` is synced from `shared/clinerules/hooks/PreToolUse`.
- `.clinerules/hooks/pretooluse.py` is synced from `shared/clinerules/hooks/pretooluse.py`.
