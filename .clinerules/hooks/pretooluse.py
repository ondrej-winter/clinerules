...
SUPPORTED_TOOL_ARGUMENT_FORMATTERS: dict[str, ToolArgumentFormatter] = {
    ...
    'access_mcp_resource': lambda parameters: _format_key_values(
        parameters, 'server_name', 'uri'
    ),
    'ask_followup_question': lambda parameters: _format_key_values(
        parameters, 'question'
    ),
    'attempt_completion': lambda parameters: _format_key_values(
        parameters, 'result', 'command'
    ),
    'browser_action': lambda parameters: _format_key_values(
        parameters, 'action', 'url', 'coordinate', 'text'
    ),
    ...
    'use_mcp_tool': lambda parameters: _format_key_values(
        parameters, 'server_name', 'tool_name'
    ),
