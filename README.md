...
- `tools/sync-shared/sync_shared.py`: Copies shared repository assets into their configured target locations. It supports file and directory sources, and each source can sync to multiple targets.
