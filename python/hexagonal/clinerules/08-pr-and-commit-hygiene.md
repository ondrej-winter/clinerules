...
- **Should** call out rollout, migration, rollback, or feature-flag considerations when operational risk is non-trivial.
...
- **Must not** leave `WIP`, `fixup!`, or `squash!` commits in shared history unless the team workflow explicitly relies on later autosquash.
