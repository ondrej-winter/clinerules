...
Use this workflow when adapting the reusable hexagonal Python ruleset to a specific repository.
...
5. Record the most useful repository-specific search commands for ports, adapters, entry points, and tests.
